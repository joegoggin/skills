...
| `$refactor` | Suggests behavior-preserving refactors one at a time with affected files, code examples, and file tree changes when needed. | `refactor/agents/openai.yaml` |
